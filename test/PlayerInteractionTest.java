...
public class PlayerInteractionTest {
    public static void main(String[] args) {
        ...
        Board board1 = new Board(difficulty.getBoardSize(), difficulty.getTotalQuantityBoats(), generateBoatsList(difficulty));
        board1.placeShips();
        Board board2 = new Board(difficulty.getBoardSize(), difficulty.getTotalQuantityBoats(), generateBoatsList(difficulty));
        board2.placeShips();
